<div id ="footer">
  <div id="footer-container">
      <div class="footer-cat">
        <p class="footer-category">Website</p>
        <p class="footer-item"><a class="footer-link" href="#">Home</a></p>
        <p class="footer-item"><a class="footer-link" href="#">About</a></p>
      </div>
      <div class="footer-cat">
        <p class="footer-category">Other Services</p>
        <p class="footer-item"><a class="footer-link" href="#">DirtyHentai.moe</a></p>
